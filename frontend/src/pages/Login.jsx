          ...
          <div className="absolute bottom-12 left-12 right-12 z-20 space-y-6">
            ...
            <div className="space-y-4">
              <h2 className="text-5xl font-extrabold text-white leading-tight tracking-[-0.02em]">
                Ready to <br />
                <span className="text-[#4dd0e1] italic">Scale Up?</span>
              </h2>
              <p className="text-white/80 text-lg font-medium max-w-sm">
                Sign in to continue your journey and unlock new career opportunities with our AI.
              </p>
            </div>
        ...
        <div className="w-full md:w-[55%] flex flex-col justify-center p-8 md:p-16 relative bg-[#fafbff]">
          ...
          <div className="max-w-md w-full mx-auto space-y-8">
            <div className="space-y-2">
              <h1 className="text-4xl font-[800] tracking-tight text-slate-900">Welcome Back</h1>
              <p className="text-slate-500 font-medium tracking-tight">Your next big opportunity is just a sign-in away.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button type="submit" className="w-full h-14 text-lg font-bold shadow-xl shadow-slate-200/50 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] rounded-[10px] bg-gradient-to-br from-[#1a1a2e] to-[#16213e] text-white mt-4 border-none" disabled={loading}>
                {loading ? <LoadingSpinner size={24} message={null} /> : 'Login'}
              </Button>
            </form>

            <div className="relative flex items-center gap-4 py-2">
              <div className="h-px w-full bg-slate-100"></div>
              <span className="text-slate-400 text-[10px] font-bold uppercase tracking-[0.2em] whitespace-nowrap">OR CONTINUE WITH</span>
              <div className="h-px w-full bg-slate-100"></div>
            </div>
            ...
            <p className="text-center text-slate-500 font-medium pt-4">
              Not a member?{" "}
              <Link to="/signup" className="text-[#4dd0e1] font-bold hover:text-[#4dd0e1]/80 transition-all">
                Create Account
              </Link>
            </p>
          </div>
